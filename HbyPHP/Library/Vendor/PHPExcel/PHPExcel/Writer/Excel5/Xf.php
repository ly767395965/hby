...
class PHPExcel_Writer_Excel5_Xf
{
	...
	*/
	...
	/**
	 * Wap of BIFF2-BIFF8 codes for border styles
	 * @static	array of int
	 *
	 */
	...
	/**
	 * Wap of BIFF2-BIFF8 codes for fill types
	 * @static	array of int
	 *
	 */
	...
	/**
	 * Wap of BIFF2-BIFF8 codes for horizontal alignment
	 * @static	array of int
	 *
	 */
	...
	/**
	 * Wap to BIFF2-BIFF8 codes for horizontal alignment
	 *
	 * @param string $hAlign
	 * @return int
	 */
	...
	/**
	 * Wap of BIFF2-BIFF8 codes for vertical alignment
	 * @static	array of int
	 *
	 */
	...
	/**
	 * Wap to BIFF2-BIFF8 codes for vertical alignment
	 *
	 * @param string $vAlign
	 * @return int
	 */
	...
	/**
	 * Wap to BIFF8 codes for text rotation angle
	 *
