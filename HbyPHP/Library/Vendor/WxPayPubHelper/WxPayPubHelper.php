<?php
namespace Vendor\WxPayPubHelper;
/**
 * 微信支付帮助库
 * ====================================================
 * 接口分三种类型：
...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.hbzc777.com/Home/Index/Index';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.hbzc777.com/Home/WexinPay/notify';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wxa56ecda4125bfaca';
			//受理商ID，身份标识
			$this->MCHID = '1411534302';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'hby6OH693GZK2g031C7R4xI120pcl5lS';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'b34aeaac1261a5f31ed9f3f483df2b4f';
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
