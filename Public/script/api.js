...
//首页推荐车型
function upDate(ret) {
    var url="http://59.110.60.130/";
    var str = "";
    var imgUrl = "";
    for (var i = 0; i < ret.car.length; i++) {
         if (ret.car[i].frontimg == "" || ret.car[i].frontimg == null){
             imgUrl = "../image/default-img.jpg";
         } else {
        imgUrl = url + "Public" + ret.car[i].frontimg;
        }
        str += '<li tapmode="home-listhover" id="' + ret.car[i].id + '"><div class="list-pic">' +
            '<img src="' + imgUrl + '" />' +
            '</div><div class="list-dis"><div class="list-dis-left">' +
            '<p>' + ret.car[i].carmodelname + '</p>' +
            '<span>' + ret.car[i].configstyle + '</span> <span class="txt-line">|</span> ' +
            '<span>' + ret.car[i].bearboxtype + '</span> <span class="txt-line">|</span> ' +
            '<span>' + ret.car[i].fuelstand + '</span>' +
            '</div><div class="list-dis-right"><span>￥</span>' +
            '<b class="rijun">0</b>' +
            '<i>/日均</i></div><div class="clear"></div><div class="list-dis-line"></div><div class="list-dis-zct">' +
...
//正在加载动画
var loadingg='<div id="loading"><div class="load-yuan"></div><div class="load-text">载入中.</div></div>';
function showLoad() {
    $("body").append(loadingg);
}
function hidenLoad() {
    $("#loading").remove();
}
//加载更多动画
var lodMore='<div class="spinner">' +
    '<div class="bounce1"></div>' +
    '<div class="bounce2"></div>' +
    '<div class="bounce3"></div></div>';
var neterro='<div id="neterro"><img src="../image/neterro.png" />网络故障，请检查网络</div>';
var noorder='<div id="neterro"><img src="../image/orderNo.png" />没有相关订单</div>';
//计算时间之差
...
//登录注册等待
var loadWater='<div class="sk-circle"><div class="sk-circle1 sk-child"></div><div class="sk-circle2 sk-child"></div>' +
